...
public class Mover {
    ...
    private void moveHorizontally(Snake snake, Board board, int size, Cell head, int row, int column, int tempRow, int tempColumn, int i, Counter counter) {
    ...
    private void addToSnakeAndCount(Snake snake, int size, int row, int column, Counter counter) {
